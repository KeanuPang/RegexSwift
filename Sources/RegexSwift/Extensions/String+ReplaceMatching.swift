...
extension String {
    ...
    public mutating func replaceFirst(matching regex: RegexSwift, with template: String) {
    ...
    public mutating func replaceFirst(matching pattern: StaticString, with template: String) {
        replaceFirst(matching: RegexSwift(pattern), with: template)
    }
    ...
    public func replacingFirst(matching regex: RegexSwift, with template: String) -> String {
        var string = self
    ...
    public func replacingFirst(matching pattern: StaticString, with template: String) -> String {
        return replacingFirst(matching: RegexSwift(pattern), with: template)
    }
    ...
    ///     - regex: A regular expression to match against `self`.
    ///     - template: A template string used to replace matches.
    public mutating func replaceAll(matching regex: RegexSwift, with template: String) {
    ...
    public mutating func replaceAll(matching pattern: StaticString, with template: String) {
        replaceAll(matching: RegexSwift(pattern), with: template)
    }
    ...
    public func replacingAll(matching regex: RegexSwift, with template: String) -> String {
        var string = self
    ...
    public func replacingAll(matching pattern: StaticString, with template: String) -> String {
        return replacingAll(matching: RegexSwift(pattern), with: template)
    }
}
